...
const ButtonLarger = ({text, mainColour, href, icon, click}) => {
    return (
            <div onClick={click} className={`${mainColour} cursor-pointer px-3 py-2 xxl:px-8 xxl:py-6 flex items-center font-editorial text-3xl`}>
                {text} 
